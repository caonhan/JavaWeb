			...
			<div class="panel panel-primary">
				...
				<form:form id="update" method="POST" commandName="poUpdate"
					...
					<div class="col-md-6">
						...
						<form:input path="poId" type="text" />
						<br /> <br />
						 <label><r:message	code="productionorder.order" /></label>
						  <input type="text" value="${poUpdate.orders.orderId}" name="orderId" /> 
						 
						  <br /> <br /> 
							<label><r:message	code="productionorder.content" /></label>
