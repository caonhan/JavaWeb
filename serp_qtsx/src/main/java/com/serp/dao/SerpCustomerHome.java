 ...
 */
public class SerpCustomerHome {

	private static final Log log = LogFactory.getLog(SerpCustomerHome.class);
	...
	public Customer merge(Customer detachedInstance) {
		...
		try {
			Customer result = (Customer) sessionFactory
	...
	public Customer findById(int id) {
		...
		try {
			Customer instance = (Customer) sessionFactory
					.getCurrentSession().get("com.serp.dao.SerpCustomer", id);
			if (instance == null) {
	...
	public List<Customer> findByExample(Customer instance) {
		...
		try {
			List<Customer> results = (List<Customer>) sessionFactory
					.getCurrentSession()
					.createCriteria("com.serp.dao.SerpCustomer")
